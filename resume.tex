...
%     \begin{itemize}
%         Image Processing Onramp, Innofusion'25, Ultron 8.0, Vertex Innovate Organizer,  Oracle Cloud Infrastructure 2024 Certified Foundations Associate, Advanced Programming in Swift, Hack Day - First Edition, Supervised Machine Learning: Regression and Classification , Viksit Bharat Quiz Challenge, Programming in Java, Smart India Hackathon 2024, Dark Patterns Buster Hackathon 2023, Design and Develop, Preface - UI/UX Design, Responsive Web Design, C Programming - Professional Level, C Programming, Certificate of Participation in PixelX-24 hours Designathon, Go (Basic) Certificate, Node (Basic) Certificate
%     \end{itemize}
