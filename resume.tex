...
\end{itemize}
\textbf{\href{https://github.com/Rahuletto/rocket}{rocket}} \(\mid\) \textbf{Rust,Tauri,React,Typescript}
\begin{itemize}
\itemsep -3pt{}
...
\item Significantly reduced resource load for users, leading to a smoother and more efficient coding experience when developing a resource-intensive project
\end{itemize}
\end{rSection}
% \vspace{1.5em}
